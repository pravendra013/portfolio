  ...
  return (
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        ...
        <div className="head2">
          <h1 className={`${styles.heroHeadText} text-white`}>
            Hii there, I'm <p className='name text-[#915EFF]'>Pravendra Kumar</p>
          </h1>
          <h3>
        ...
        <a
          href="https://github.com/pravendra013" target="_blank">
          <AiOutlineGithub />
        </a>
        <a
        ...
        <a
          href="https://www.instagram.com/itsdavid_132/" target="_blank">
          <AiOutlineInstagram />
        </a>
      ...
      <div className="imgcontainer1 absolute violet-gradient">
        <img src={davidImG} alt="" className="object-contain"/>
      </div>
      </div>
