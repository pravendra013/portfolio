  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Pravendra Kumar",
          from_email: form.email,
          to_email: "kumar.pravendra1990@gmail.com",
      ...
      >
        ...
        <div className="mt-5 contact__options">
          <article className="contact__option">
            <MdEmail />
            <a href="mailto:kumar.pravendra1990@gmail.com" target="_blank" className="blue-text-gradient">kumar.pravendra1990@gmail.com</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp />
